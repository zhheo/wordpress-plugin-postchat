...
function postchat_enqueue_custom_js() {
  ...
  $enableSummary = isset($options['enableSummary']) ? $options['enableSummary'] : false;
  $enableAI = isset($options['enableAI']) ? $options['enableAI'] : false;
  ...
  <script>
    ...
    let tianliGPT_typingAnimate = <?php echo esc_js($options['typingAnimate'] ? 'true' : 'false'); ?>;
    var postChatConfig = {
      ...
      defaultInput: <?php echo esc_js($options['defaultInput'] ? 'true' : 'false'); ?>,
      upLoadWeb: <?php echo esc_js($options['upLoadWeb'] ? 'true' : 'false'); ?>,
      showInviteLink: <?php echo esc_js($options['showInviteLink'] ? 'true' : 'false'); ?>,
      userTitle: "<?php echo esc_js($options['userTitle']); ?>",
      userDesc: "<?php echo esc_js($options['userDesc']); ?>",
      addButton: <?php echo esc_js($options['addButton'] ? 'true' : 'false'); ?>
    };
  </script>
